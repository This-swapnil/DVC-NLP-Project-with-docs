...
def main(config_path, params_path):
    ...
    seed = params["prepare"]["seed"]  # random seed
    ...
    with open(
        source_data_path, encoding=encode
    ) as fd_in:  # actual input data that we are reading
        with open(
            train_data_path, "w", encoding=encode
        ) as fd_out_train:  # writing train data
            with open(
                test_data_path, "w", encoding=encode
            ) as fd_out_test:  # writing test data
